...
export const FORM_STEPS: StepItem[] = [
  { id: 1, title: "Personal Details", subtitle: "Passport scan, personal details & contact" },
  ...
  { id: 4, title: "Medical & Clearances", subtitle: "Medical fitness & regulatory clearance" },
