  ...
  const htmlContent = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          Confidential • Applicant Processing & Operations Report • Generated by Agency Workflow Portal
        </div>
...
// Export aliases for clarity across components
export const exportToExcel = exportToCSV;
export const exportToPDF = exportToPrintPDF;
